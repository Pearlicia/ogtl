require 'sqlite3'
 ...
 class User
    ...
    def self.create(user_info)
        @db = self.connection
        @db.execute "INSERT INTO users (firstname, lastname, age, password, email) values(#{user_info[]},?,?,?,?)" , user_info['firstname'], user_info['lastname'], user_info['age'], user_info['password'], user_info['email'] 
