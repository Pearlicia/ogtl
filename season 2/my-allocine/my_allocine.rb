...
requests["Find the name of movie and director who directed a movies that casted a role as Sean Maguire"] = "SELECT dir_fname, dir_lname, mov_title FROM movies JOIN directors_movies ON movies.id = directors_movies.mov_id JOIN directors ON directors.id = directors_movies.dir_id JOIN movies_actors ON movies.id = movies_actors.mov_id JOIN actors ON actors.id = movies_actors.act_id WHERE role = 'Sean Maguire';"

requests["Find all the actors who have not acted in any movie between 1990 and 2000 (select only actor first name, last name, movie title and release year)"] = "SELECT DISTINCT act_fname, act_lname, mov_title, mov_year FROM actors LEFT JOIN movies_actors ON actors.id = movies_actors.act_id LEFT JOIN movies ON movies.id = movies_actors.mov_id WHERE actors.id NOT IN (SELECT DISTINCT actors.id FROM actors JOIN movies_actors ON actors.id = movies_actors.act_id JOIN movies ON movies_actors.mov_id = movies.id WHERE mov_year BETWEEN 1990 AND 2000);"
# requests["Find all the actors who have not acted in any movie between 1990 and 2000 (select only actor first name, last name, movie title and release year)"] = "SELECT DISTINCT act_fname, act_lname, mov_title, mov_year FROM actors LEFT JOIN movies_actors ON actors.id = movies_actors.act_id LEFT JOIN movies ON movies_actors.mov_id = movies.id WHERE actors.id NOT IN (SELECT DISTINCT actors.id FROM actors JOIN movies_actors ON actors.id = movies_actors.act_id JOIN movies ON movies_actors.mov_id = movies.id WHERE mov_year BETWEEN 1990 AND 2000);"

# requests["Find all the actors who have not acted in any movie between 1990 and 2000 (select only actor first name, last name, movie title and release year)"] = "SELECT actors.act_fname, actors.act_lname, movies.mov_title, movies.mov_year FROM actors LEFT JOIN movies_actors ON actors.id = movies_actors.act_id LEFT JOIN movies ON movies.id = movies_actors.mov_id WHERE movies.mov_year < 1990 OR movies.mov.year > 2000 OR movies.mov_year IS NOT NULL;"

# requests["Find all the actors who have not acted in any movie between 1990 and 2000 (select only actor first name, last name, movie title and release year)"] = "SELECT act_fname, act_lname, mov_title, mov_year FROM actors JOIN movies_actors ON actors.id = movies_actors.act_id JOIN movies ON movies_actors.mov_id = movies.id WHERE mov_year NOT BETWEEN 1990 AND 2000 ORDER BY act_lname, act_fname, mov_year;"
# requests["Find all the actors who have not acted in any movie between 1990 and 2000 (select only actor first name, last name, movie title and release year)"] = "SELECT actors.act_fname, actors.act_lname, movies.mov_title, movies.mov_year FROM actors LEFT JOIN movies_actors ON actors.id = movies_actors.act_id LEFT JOIN movies ON movies.id = movies_actors.mov_id WHERE movies.mov_year < 1990 AND movies.mov_year > 2000 AND movies.mov_year <> 1997 OR movies.mov_year IS NOT NULL;"
# requests["Find all the actors who have not acted in any movie between 1990 and 2000 (select only actor first name, last name, movie title and release year)"] = "SELECT actors.act_fname, actors.act_lname, movies.mov_title, movies.mov_year FROM actors LEFT JOIN movies_actors ON actors.id = movies_actors.act_id LEFT JOIN movies ON movies.id = movies_actors.mov_id WHERE movies.mov_year NOT BETWEEN 1990 AND 2000 OR movies.mov_year IS NOT NULL;"
# requests["Find all the actors who have not acted in any movie between 1990 and 2000 (select only actor first name, last name, movie title and release year)"] = "SELECT act_fname, act_lname, mov_title, mov_year FROM actors LEFT JOIN movies_actors ON actors.id = movies_actors.act_id LEFT JOIN movies ON movies.id = movies_actors.mov_id WHERE mov_year NOT BETWEEN 1990 AND 2000 ORDER BY actors.act_lname, actors.act_fname, movies.mov_year, movies.mov_title;"